...
if(localStorage.getItem("userIdade") != []){
    document.getElementById("userIdade").value = localStorage.getItem("userIdade");
}

//Função para exibir alerta quando o botão foi clicado
...
function idadeAlert(){
    if(document.getElementById("userIdade").value != [] && document.getElementById("userIdade").value > 0){
